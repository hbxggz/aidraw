...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aidraw
```

A live public deployment of this template is available at [https://aidraw.templates.workers.dev](https://aidraw.templates.workers.dev)
